...
import type { QueryKey, QueryFunctionContext } from '@tanstack/vue-query';
...
export function uploadFileMutationKey(petId: number): MutationKey {
  return trimArrayEnd(['Client', 'uploadFile', petId as any]);
}
 ...
 */
export function useUploadFileMutation<TContext>(
  petId: number,
  options?: Omit<
    UseMutationOptions<
      Types.ApiResponse,
      unknown,
      UploadFileMutationParameters,
      TContext
    >,
...
> {
  ...
  return useMutation(
    (uploadFileMutationParameters: UploadFileMutationParameters) =>
      Types.Client.uploadFile(
        petId,
        uploadFileMutationParameters.additionalMetadata,
        uploadFileMutationParameters.file,
      ),
...
export function addPetMutationKey(): MutationKey {
  return trimArrayEnd(['Client', 'addPet']);
}
 ...
 */
export function useAddPetMutation<TContext>(
  options?: Omit<
    UseMutationOptions<void, unknown, Types.Pet, TContext>,
    'mutationKey' | 'mutationFn'
  >,
): UseMutationResult<void, unknown, Types.Pet, TContext> {
  const key = addPetMutationKey();

  const metaContext = useContext(QueryMetaContext);
  options = addMetaToOptions(options, metaContext);

  return useMutation((body: Types.Pet) => Types.Client.addPet(body), {
    ...options,
    mutationKey: key,
  });
}
...
export function updatePetMutationKey(): MutationKey {
  return trimArrayEnd(['Client', 'updatePet']);
}
 ...
 * @param body Pet object that needs to be added to the store
 */
export function useUpdatePetMutation<TContext>(
  options?: Omit<
    UseMutationOptions<void, unknown, Types.Pet, TContext>,
    'mutationKey' | 'mutationFn'
  >,
  ...
  return useMutation((body: Types.Pet) => Types.Client.updatePet(body), {
    ...options,
    mutationKey: key,
  });
}
...
let findPetsByStatusDefaultOptions: UseQueryOptions<
  Types.Pet[],
  unknown,
  Types.Pet[]
> = {
...
export function getFindPetsByStatusDefaultOptions(): UseQueryOptions<
  Types.Pet[],
  unknown,
  Types.Pet[]
> {
...
export function setFindPetsByStatusDefaultOptions(
  options: UseQueryOptions<Types.Pet[], unknown, Types.Pet[]>,
) {
...
export function findPetsByStatusQueryKey(...params: any[]): QueryKey {
  if (params.length === 1 && isParameterObject(params[0])) {
    ...
    return trimArrayEnd(['Client', 'findPetsByStatus', status as any]);
  } else {
    return trimArrayEnd(['Client', 'findPetsByStatus', ...params]);
  }
}
function __findPetsByStatus(context: QueryFunctionContext) {
  return Types.Client.findPetsByStatus(context.queryKey[2] as Types.Status[]);
}

export function useFindPetsByStatusQuery<
  TSelectData = Types.Pet[],
  TError = unknown,
>(
  dto: FindPetsByStatusQueryParameters,
  options?: UseQueryOptions<Types.Pet[], TError, TSelectData>,
...
>(...params: any[]): UseQueryResult<TSelectData, TError> {
  let options: UseQueryOptions<Types.Pet[], TError, TSelectData> | undefined =
    undefined;
  ...
  return useQuery<Types.Pet[], TError, TSelectData>({
    ...
    ...(findPetsByStatusDefaultOptions as unknown as UseQueryOptions<
      Types.Pet[],
      TError,
      TSelectData
    >),
 ...
 * @return successful operation
 */
export function setFindPetsByStatusData(
  queryClient: QueryClient,
  updater: (data: Types.Pet[] | undefined) => Types.Pet[],
  status: Types.Status[],
) {
  queryClient.setQueryData(findPetsByStatusQueryKey(status), updater);
}
 ...
 * @return successful operation
 */
export function setFindPetsByStatusDataByQueryId(
  queryClient: QueryClient,
  queryKey: QueryKey,
  updater: (data: Types.Pet[] | undefined) => Types.Pet[],
) {
...
let findPetsByTagsDefaultOptions: UseQueryOptions<
  Types.Pet[],
  unknown,
  Types.Pet[]
> = {
...
export function getFindPetsByTagsDefaultOptions(): UseQueryOptions<
  Types.Pet[],
  unknown,
  Types.Pet[]
> {
...
export function setFindPetsByTagsDefaultOptions(
  options: UseQueryOptions<Types.Pet[], unknown, Types.Pet[]>,
) {
...
export function findPetsByTagsQueryKey(...params: any[]): QueryKey {
  if (params.length === 1 && isParameterObject(params[0])) {
    ...
    return trimArrayEnd(['Client', 'findPetsByTags', tags as any]);
  } else {
    return trimArrayEnd(['Client', 'findPetsByTags', ...params]);
  }
}
function __findPetsByTags(context: QueryFunctionContext) {
  return Types.Client.findPetsByTags(context.queryKey[2] as string[]);
}
...
>(...params: any[]): UseQueryResult<TSelectData, TError> {
  ...
  return useQuery<Types.Pet[], TError, TSelectData>({
    ...
    ...(findPetsByTagsDefaultOptions as unknown as UseQueryOptions<
      Types.Pet[],
      TError,
      TSelectData
    >),
 ...
 * @deprecated
 */
export function setFindPetsByTagsData(
  queryClient: QueryClient,
  updater: (data: Types.Pet[] | undefined) => Types.Pet[],
  tags: string[],
) {
  queryClient.setQueryData(findPetsByTagsQueryKey(tags), updater);
}
 ...
 * @deprecated
 */
export function setFindPetsByTagsDataByQueryId(
  queryClient: QueryClient,
  queryKey: QueryKey,
  updater: (data: Types.Pet[] | undefined) => Types.Pet[],
) {
...
export function getGetPetByIdDefaultOptions(): UseQueryOptions<
  Types.Pet,
  unknown,
  Types.Pet
> {
...
export function setGetPetByIdDefaultOptions(
  options: UseQueryOptions<Types.Pet, unknown, Types.Pet>,
) {
...
export function getPetByIdQueryKey(...params: any[]): QueryKey {
  if (params.length === 1 && isParameterObject(params[0])) {
    ...
    return trimArrayEnd(['Client', 'getPetById', petId as any]);
  } else {
    return trimArrayEnd(['Client', 'getPetById', ...params]);
  }
}
function __getPetById(context: QueryFunctionContext) {
  return Types.Client.getPetById(context.queryKey[2] as number);
}

export function useGetPetByIdQuery<TSelectData = Types.Pet, TError = unknown>(
...
export function useGetPetByIdQuery<TSelectData = Types.Pet, TError = unknown>(
  ...
  return useQuery<Types.Pet, TError, TSelectData>({
    ...
    ...(getPetByIdDefaultOptions as unknown as UseQueryOptions<
      Types.Pet,
      TError,
      TSelectData
    >),
 ...
 * @return successful operation
 */
export function setGetPetByIdData(
  queryClient: QueryClient,
  updater: (data: Types.Pet | undefined) => Types.Pet,
  petId: number,
) {
  queryClient.setQueryData(getPetByIdQueryKey(petId), updater);
}
 ...
 * @return successful operation
 */
export function setGetPetByIdDataByQueryId(
  queryClient: QueryClient,
  queryKey: QueryKey,
  updater: (data: Types.Pet | undefined) => Types.Pet,
) {
...
export function updatePetWithFormMutationKey(petId: number): MutationKey {
  return trimArrayEnd(['Client', 'updatePetWithForm', petId as any]);
}
 ...
 */
export function useUpdatePetWithFormMutation<TContext>(
  petId: number,
  options?: Omit<
    UseMutationOptions<
      void,
      unknown,
      UpdatePetWithFormMutationParameters,
      TContext
    >,
    'mutationKey' | 'mutationFn'
  >,
...
> {
  ...
  return useMutation(
    (
      ...
      Types.Client.updatePetWithForm(
        petId,
        updatePetWithFormMutationParameters.name,
        updatePetWithFormMutationParameters.status,
      ),
    { ...options, mutationKey: key },
  );
}

export function deletePetUrl(
  petId: number,
...
export function deletePetMutationKey(
  petId: number,
  api_key: string | null | undefined,
): MutationKey {
  return trimArrayEnd(['Client', 'deletePet', petId as any, api_key as any]);
}
 ...
 */
export function useDeletePetMutation<TContext>(
  petId: number,
  api_key: string | null | undefined,
  options?: Omit<
  ...
  return useMutation(() => Types.Client.deletePet(api_key, petId), {
    ...options,
    mutationKey: key,
  });
}
...
export function placeOrderMutationKey(): MutationKey {
  return trimArrayEnd(['Client', 'placeOrder']);
}
 ...
 * @return successful operation
 */
export function usePlaceOrderMutation<TContext>(
  options?: Omit<
    UseMutationOptions<Types.Order, unknown, Types.Order, TContext>,
    'mutationKey' | 'mutationFn'
  >,
): UseMutationResult<Types.Order, unknown, Types.Order, TContext> {
  const key = placeOrderMutationKey();

  const metaContext = useContext(QueryMetaContext);
  options = addMetaToOptions(options, metaContext);

  return useMutation((body: Types.Order) => Types.Client.placeOrder(body), {
    ...options,
    mutationKey: key,
  });
}
...
let getOrderByIdDefaultOptions: UseQueryOptions<
  Types.Order,
  unknown,
  Types.Order
> = {
...
export function getGetOrderByIdDefaultOptions(): UseQueryOptions<
  Types.Order,
  unknown,
  Types.Order
> {
...
export function setGetOrderByIdDefaultOptions(
  options: UseQueryOptions<Types.Order, unknown, Types.Order>,
) {
...
export function getOrderByIdQueryKey(...params: any[]): QueryKey {
  if (params.length === 1 && isParameterObject(params[0])) {
    ...
    return trimArrayEnd(['Client', 'getOrderById', orderId as any]);
  } else {
    return trimArrayEnd(['Client', 'getOrderById', ...params]);
  }
}
function __getOrderById(context: QueryFunctionContext) {
  return Types.Client.getOrderById(context.queryKey[2] as number);
}

export function useGetOrderByIdQuery<
  TSelectData = Types.Order,
  TError = unknown,
>(
  dto: GetOrderByIdQueryParameters,
  options?: UseQueryOptions<Types.Order, TError, TSelectData>,
): UseQueryResult<TSelectData, TError>;
/**
...
export function useGetOrderByIdQuery<
  ...
  TError = unknown,
>(...params: any[]): UseQueryResult<TSelectData, TError> {
  let options: UseQueryOptions<Types.Order, TError, TSelectData> | undefined =
    undefined;
  ...
  return useQuery<Types.Order, TError, TSelectData>({
    ...
    ...(getOrderByIdDefaultOptions as unknown as UseQueryOptions<
      Types.Order,
      TError,
      TSelectData
    >),
 ...
 * @return successful operation
 */
export function setGetOrderByIdData(
  queryClient: QueryClient,
  updater: (data: Types.Order | undefined) => Types.Order,
  orderId: number,
) {
  queryClient.setQueryData(getOrderByIdQueryKey(orderId), updater);
}
 ...
 * @return successful operation
 */
export function setGetOrderByIdDataByQueryId(
  queryClient: QueryClient,
  queryKey: QueryKey,
  updater: (data: Types.Order | undefined) => Types.Order,
) {
...
export function deleteOrderMutationKey(orderId: number): MutationKey {
  return trimArrayEnd(['Client', 'deleteOrder', orderId as any]);
}
 ...
 */
export function useDeleteOrderMutation<TContext>(
  orderId: number,
  options?: Omit<
    UseMutationOptions<void, unknown, void, TContext>,
    'mutationKey' | 'mutationFn'
  ...
  return useMutation(() => Types.Client.deleteOrder(orderId), {
    ...options,
    mutationKey: key,
  });
}
...
let getInventoryDefaultOptions: UseQueryOptions<
  { [key: string]: number },
  unknown,
  { [key: string]: number }
> = {
...
export function getGetInventoryDefaultOptions(): UseQueryOptions<
  { [key: string]: number },
  unknown,
  { [key: string]: number }
> {
...
export function setGetInventoryDefaultOptions(
...
export function getInventoryQueryKey(...params: any[]): QueryKey {
  return trimArrayEnd(['Client', 'getInventory']);
}
...
>(...params: any[]): UseQueryResult<TSelectData, TError> {
  ...
  return useQuery<{ [key: string]: number }, TError, TSelectData>({
    ...
    ...(getInventoryDefaultOptions as unknown as UseQueryOptions<
      { [key: string]: number },
      TError,
      TSelectData
    >),
 ...
 * @return successful operation
 */
export function setGetInventoryData(
  queryClient: QueryClient,
  updater: (data: { [key: string]: number } | undefined) => {
    [key: string]: number;
  },
) {
  queryClient.setQueryData(getInventoryQueryKey(), updater);
}
 ...
 * @return successful operation
 */
export function setGetInventoryDataByQueryId(
  queryClient: QueryClient,
  queryKey: QueryKey,
  updater: (data: { [key: string]: number } | undefined) => {
    [key: string]: number;
...
export function createUsersWithArrayInputMutationKey(): MutationKey {
  return trimArrayEnd(['Client', 'createUsersWithArrayInput']);
}
 ...
 * @return successful operation
 */
export function useCreateUsersWithArrayInputMutation<TContext>(
  options?: Omit<
    UseMutationOptions<void, unknown, Types.User[], TContext>,
    'mutationKey' | 'mutationFn'
  >,
): UseMutationResult<void, unknown, Types.User[], TContext> {
  ...
  return useMutation(
    (body: Types.User[]) => Types.Client.createUsersWithArrayInput(body),
    { ...options, mutationKey: key },
  );
}
...
export function createUsersWithListInputMutationKey(): MutationKey {
  return trimArrayEnd(['Client', 'createUsersWithListInput']);
}
 ...
 * @return successful operation
 */
export function useCreateUsersWithListInputMutation<TContext>(
  options?: Omit<
    UseMutationOptions<void, unknown, Types.User[], TContext>,
    'mutationKey' | 'mutationFn'
  >,
  ...
  return useMutation(
    (body: Types.User[]) => Types.Client.createUsersWithListInput(body),
    { ...options, mutationKey: key },
  );
}
...
let getUserByNameDefaultOptions: UseQueryOptions<
  Types.User,
  unknown,
  Types.User
> = {
...
export function getGetUserByNameDefaultOptions(): UseQueryOptions<
  Types.User,
  unknown,
  Types.User
> {
...
export function setGetUserByNameDefaultOptions(
  options: UseQueryOptions<Types.User, unknown, Types.User>,
) {
...
export function getUserByNameQueryKey(...params: any[]): QueryKey {
  if (params.length === 1 && isParameterObject(params[0])) {
    ...
    return trimArrayEnd(['Client', 'getUserByName', username as any]);
  } else {
    return trimArrayEnd(['Client', 'getUserByName', ...params]);
  }
}
function __getUserByName(context: QueryFunctionContext) {
  return Types.Client.getUserByName(context.queryKey[2] as string);
}

export function useGetUserByNameQuery<
  TSelectData = Types.User,
  TError = unknown,
>(
  dto: GetUserByNameQueryParameters,
  options?: UseQueryOptions<Types.User, TError, TSelectData>,
): UseQueryResult<TSelectData, TError>;
/**
...
export function useGetUserByNameQuery<
  ...
  TError = unknown,
>(...params: any[]): UseQueryResult<TSelectData, TError> {
  let options: UseQueryOptions<Types.User, TError, TSelectData> | undefined =
    undefined;
  ...
  return useQuery<Types.User, TError, TSelectData>({
    ...
    ...(getUserByNameDefaultOptions as unknown as UseQueryOptions<
      Types.User,
      TError,
      TSelectData
    >),
 ...
 * @return successful operation
 */
export function setGetUserByNameData(
  queryClient: QueryClient,
  updater: (data: Types.User | undefined) => Types.User,
  username: string,
) {
  queryClient.setQueryData(getUserByNameQueryKey(username), updater);
}
 ...
 * @return successful operation
 */
export function setGetUserByNameDataByQueryId(
  queryClient: QueryClient,
  queryKey: QueryKey,
  updater: (data: Types.User | undefined) => Types.User,
) {
...
export function updateUserMutationKey(username: string): MutationKey {
  return trimArrayEnd(['Client', 'updateUser', username as any]);
}
 ...
 */
export function useUpdateUserMutation<TContext>(
  username: string,
  options?: Omit<
    UseMutationOptions<void, unknown, Types.User, TContext>,
    'mutationKey' | 'mutationFn'
  ...
  return useMutation(
    (body: Types.User) => Types.Client.updateUser(username, body),
    { ...options, mutationKey: key },
  );
}
...
export function deleteUserMutationKey(username: string): MutationKey {
  return trimArrayEnd(['Client', 'deleteUser', username as any]);
}
 ...
 */
export function useDeleteUserMutation<TContext>(
  username: string,
  options?: Omit<
    UseMutationOptions<void, unknown, void, TContext>,
    'mutationKey' | 'mutationFn'
  ...
  return useMutation(() => Types.Client.deleteUser(username), {
    ...options,
    mutationKey: key,
  });
}
...
export function getLoginUserDefaultOptions(): UseQueryOptions<
  string,
  unknown,
  string
> {
...
export function setLoginUserDefaultOptions(
...
export function loginUserQueryKey(...params: any[]): QueryKey {
  if (params.length === 1 && isParameterObject(params[0])) {
    ...
    return trimArrayEnd(['Client', 'loginUser', ...params]);
  }
}
...
export function useLoginUserQuery<TSelectData = string, TError = unknown>(
...
export function useLoginUserQuery<TSelectData = string, TError = unknown>(
  ...
  return useQuery<string, TError, TSelectData>({
    ...
    ...(loginUserDefaultOptions as unknown as UseQueryOptions<
      string,
      TError,
      TSelectData
    >),
 ...
 * @return successful operation
 */
export function setLoginUserData(
  queryClient: QueryClient,
  updater: (data: string | undefined) => string,
  username: string,
  password: string,
) {
  queryClient.setQueryData(loginUserQueryKey(username, password), updater);
}
 ...
 * @return successful operation
 */
export function setLoginUserDataByQueryId(
  queryClient: QueryClient,
  queryKey: QueryKey,
  updater: (data: string | undefined) => string,
) {
...
export function getLogoutUserDefaultOptions(): UseQueryOptions<
  void,
  unknown,
  void
> {
...
export function setLogoutUserDefaultOptions(
...
export function logoutUserQueryKey(...params: any[]): QueryKey {
  return trimArrayEnd(['Client', 'logoutUser']);
}
 ...
 * @return successful operation
 */
export function useLogoutUserQuery<TSelectData = void, TError = unknown>(
...
export function useLogoutUserQuery<TSelectData = void, TError = unknown>(
  ...
  return useQuery<void, TError, TSelectData>({
    ...
    ...(logoutUserDefaultOptions as unknown as UseQueryOptions<
      void,
      TError,
      TSelectData
    >),
 ...
 * @return successful operation
 */
export function setLogoutUserData(
  queryClient: QueryClient,
  updater: (data: void | undefined) => void,
) {
  queryClient.setQueryData(logoutUserQueryKey(), updater);
}
 ...
 * @return successful operation
 */
export function setLogoutUserDataByQueryId(
  queryClient: QueryClient,
  queryKey: QueryKey,
  updater: (data: void | undefined) => void,
) {
...
export function createUserMutationKey(): MutationKey {
  return trimArrayEnd(['Client', 'createUser']);
}
 ...
 * @return successful operation
 */
export function useCreateUserMutation<TContext>(
  options?: Omit<
    UseMutationOptions<void, unknown, Types.User, TContext>,
    'mutationKey' | 'mutationFn'
  >,
  ...
  return useMutation((body: Types.User) => Types.Client.createUser(body), {
    ...options,
    mutationKey: key,
  });
}
