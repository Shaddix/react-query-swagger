...
export function useDeletePetMutation<TContext>(petId: MaybeRef<number>, api_key?: MaybeRef<string | null | undefined>, options?: Omit<UseMutationOptions<void, unknown, void, TContext>, 'mutationKey' | 'mutationFn'>): UseMutationReturnType<void, unknown, void, TContext> {
  ...
  return useMutation({
    ...options,
    mutationFn: () => Client.deletePet(petId as any, api_key as any),
    mutationKey: key,
  });
}
...
return useMutation({
  ...options, 
  mutationFn: (data: NoRefObject<DeletePet__MutationParameters>) => Client.deletePet(data.petId ?? options?.parameters?.petId! as any, data.api_key ?? options?.parameters?.api_key! as any),
  mutationKey: key,
});
}
