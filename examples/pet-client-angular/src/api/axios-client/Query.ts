 ...
 */
export function useUploadFileMutation<TContext>(petId: number, options?: Omit<Optional<CreateMutationOptions<Types.ApiResponse, unknown, UploadFileMutationParameters, TContext>, 'mutationFn'>, 'mutationKey' | 'mutationFn'>) {
 ...
 * @return successful operation
 */
export function useUploadFileMutationWithParameters<TContext>(options?: Omit<Optional<CreateMutationOptions<Types.ApiResponse, unknown, UploadFile__MutationParameters, TContext>, 'mutationFn'>, 'mutationKey' | 'mutationFn'> & { parameters?: UploadFileQueryParameters}) {
 ...
 */
export function useAddPetMutation<TContext>(options?: Omit<Optional<CreateMutationOptions<void, unknown, Types.Pet, TContext>, 'mutationFn'>, 'mutationKey' | 'mutationFn'>) {
 ...
 * @param body Pet object that needs to be added to the store
 */
export function useUpdatePetMutation<TContext>(options?: Omit<Optional<CreateMutationOptions<void, unknown, Types.Pet, TContext>, 'mutationFn'>, 'mutationKey' | 'mutationFn'>) {
...
let findPetsByStatusDefaultOptions: Omit<Optional<UndefinedInitialDataOptions<Types.Pet[], unknown, Types.Pet[]>, 'queryFn'>, 'queryKey' | 'queryFn'> & Partial<Pick<Optional<UndefinedInitialDataOptions<Types.Pet[], unknown, Types.Pet[]>, 'queryFn'>, 'queryFn'>> = {
};
...
export function useFindPetsByStatusQuery<TSelectData = Types.Pet[], TError = unknown>(dto: FindPetsByStatusQueryParameters, options?: Omit<Optional<UndefinedInitialDataOptions<Types.Pet[], TError, TSelectData>, 'queryFn'>, 'queryKey'>, axiosConfig?: Partial<AxiosRequestConfig>): UseQueryResult<TSelectData, TError>;
/**
 * Finds Pets by status
 * @param status Status values that need to be considered for filter
 * @return successful operation
 */
export function useFindPetsByStatusQuery<TSelectData = Types.Pet[], TError = unknown>(status: Types.Status[], options?: Omit<Optional<UndefinedInitialDataOptions<Types.Pet[], TError, TSelectData>, 'queryFn'>, 'queryKey'>, axiosConfig?: Partial<AxiosRequestConfig>): UseQueryResult<TSelectData, TError>;
export function useFindPetsByStatusQuery<TSelectData = Types.Pet[], TError = unknown>(...params: any []): UseQueryResult<TSelectData, TError> {
  let options: Optional<UndefinedInitialDataOptions<Types.Pet[], TError, TSelectData>, 'queryFn'> | undefined = undefined;
  ...
  return injectQuery()<Types.Pet[], TError, TSelectData>({
    ...
    ...findPetsByStatusDefaultOptions as unknown as Omit<Optional<UndefinedInitialDataOptions<Types.Pet[], TError, TSelectData>, 'queryFn'>, 'queryKey'>,
    ...options,
  });
}
/**
...
let findPetsByTagsDefaultOptions: Omit<Optional<UndefinedInitialDataOptions<Types.Pet[], unknown, Types.Pet[]>, 'queryFn'>, 'queryKey' | 'queryFn'> & Partial<Pick<Optional<UndefinedInitialDataOptions<Types.Pet[], unknown, Types.Pet[]>, 'queryFn'>, 'queryFn'>> = {
};
...
export function useFindPetsByTagsQuery<TSelectData = Types.Pet[], TError = unknown>(dto: FindPetsByTagsQueryParameters, options?: Omit<Optional<UndefinedInitialDataOptions<Types.Pet[], TError, TSelectData>, 'queryFn'>, 'queryKey'>, axiosConfig?: Partial<AxiosRequestConfig>): UseQueryResult<TSelectData, TError>;
/**
 * Finds Pets by tags
 ...
 * @deprecated
 */
export function useFindPetsByTagsQuery<TSelectData = Types.Pet[], TError = unknown>(tags: string[], options?: Omit<Optional<UndefinedInitialDataOptions<Types.Pet[], TError, TSelectData>, 'queryFn'>, 'queryKey'>, axiosConfig?: Partial<AxiosRequestConfig>): UseQueryResult<TSelectData, TError>;
export function useFindPetsByTagsQuery<TSelectData = Types.Pet[], TError = unknown>(...params: any []): UseQueryResult<TSelectData, TError> {
  ...
  return injectQuery()<Types.Pet[], TError, TSelectData>({
    ...
    ...findPetsByTagsDefaultOptions as unknown as Omit<Optional<UndefinedInitialDataOptions<Types.Pet[], TError, TSelectData>, 'queryFn'>, 'queryKey'>,
    ...options,
  });
}
/**
...
let getPetByIdDefaultOptions: Omit<Optional<UndefinedInitialDataOptions<Types.Pet, unknown, Types.Pet>, 'queryFn'>, 'queryKey' | 'queryFn'> & Partial<Pick<Optional<UndefinedInitialDataOptions<Types.Pet, unknown, Types.Pet>, 'queryFn'>, 'queryFn'>> = {
};
...
export function useGetPetByIdQuery<TSelectData = Types.Pet, TError = unknown>(dto: GetPetByIdQueryParameters, options?: Omit<Optional<UndefinedInitialDataOptions<Types.Pet, TError, TSelectData>, 'queryFn'>, 'queryKey'>, axiosConfig?: Partial<AxiosRequestConfig>): UseQueryResult<TSelectData, TError>;
/**
 * Find pet by ID
 * @param petId ID of pet to return
 * @return successful operation
 */
export function useGetPetByIdQuery<TSelectData = Types.Pet, TError = unknown>(petId: number, options?: Omit<Optional<UndefinedInitialDataOptions<Types.Pet, TError, TSelectData>, 'queryFn'>, 'queryKey'>, axiosConfig?: Partial<AxiosRequestConfig>): UseQueryResult<TSelectData, TError>;
export function useGetPetByIdQuery<TSelectData = Types.Pet, TError = unknown>(...params: any []): UseQueryResult<TSelectData, TError> {
  ...
  return injectQuery()<Types.Pet, TError, TSelectData>({
    ...
    ...getPetByIdDefaultOptions as unknown as Omit<Optional<UndefinedInitialDataOptions<Types.Pet, TError, TSelectData>, 'queryFn'>, 'queryKey'>,
    ...options,
  });
}
/**
 ...
 */
export function useUpdatePetWithFormMutation<TContext>(petId: number, options?: Omit<Optional<CreateMutationOptions<void, unknown, UpdatePetWithFormMutationParameters, TContext>, 'mutationFn'>, 'mutationKey' | 'mutationFn'>) {
 ...
 * @param status (optional) Updated status of the pet
 */
export function useUpdatePetWithFormMutationWithParameters<TContext>(options?: Omit<Optional<CreateMutationOptions<void, unknown, UpdatePetWithForm__MutationParameters, TContext>, 'mutationFn'>, 'mutationKey' | 'mutationFn'> & { parameters?: UpdatePetWithFormQueryParameters}) {
 ...
 */
export function useDeletePetMutation<TContext>(petId: number, api_key?: string | null | undefined, options?: Omit<Optional<CreateMutationOptions<void, unknown, void, TContext>, 'mutationFn'>, 'mutationKey' | 'mutationFn'>) {
 ...
 * @param api_key (optional) 
 */
export function useDeletePetMutationWithParameters<TContext>(options?: Omit<Optional<CreateMutationOptions<void, unknown, DeletePet__MutationParameters, TContext>, 'mutationFn'>, 'mutationKey' | 'mutationFn'> & { parameters?: DeletePetQueryParameters}) {
...
let getInventoryDefaultOptions: Omit<Optional<UndefinedInitialDataOptions<{ [key: string]: number; }, unknown, { [key: string]: number; }>, 'queryFn'>, 'queryKey' | 'queryFn'> & Partial<Pick<Optional<UndefinedInitialDataOptions<{ [key: string]: number; }, unknown, { [key: string]: number; }>, 'queryFn'>, 'queryFn'>> = {
};
 ...
 * @return successful operation
 */
export function useGetInventoryQuery<TSelectData = { [key: string]: number; }, TError = unknown>(options?: Omit<Optional<UndefinedInitialDataOptions<{ [key: string]: number; }, TError, TSelectData>, 'queryFn'>, 'queryKey'>, axiosConfig?: Partial<AxiosRequestConfig>): UseQueryResult<TSelectData, TError>;
export function useGetInventoryQuery<TSelectData = { [key: string]: number; }, TError = unknown>(...params: any []): UseQueryResult<TSelectData, TError> {
  let options: Optional<UndefinedInitialDataOptions<{ [key: string]: number; }, TError, TSelectData>, 'queryFn'> | undefined = undefined;
  let axiosConfig: AxiosRequestConfig |undefined = undefined;
  ...
  return injectQuery()<{ [key: string]: number; }, TError, TSelectData>({
    queryFn: axiosConfig ? (context) => __getInventory(context, axiosConfig) : __getInventory,
    queryKey: getInventoryQueryKey(),
    ...getInventoryDefaultOptions as unknown as Omit<Optional<UndefinedInitialDataOptions<{ [key: string]: number; }, TError, TSelectData>, 'queryFn'>, 'queryKey'>,
    ...options,
  });
}
/**
 ...
 * @return successful operation
 */
export function usePlaceOrderMutation<TContext>(options?: Omit<Optional<CreateMutationOptions<Types.Order, unknown, Types.Order, TContext>, 'mutationFn'>, 'mutationKey' | 'mutationFn'>) {
...
let getOrderByIdDefaultOptions: Omit<Optional<UndefinedInitialDataOptions<Types.Order, unknown, Types.Order>, 'queryFn'>, 'queryKey' | 'queryFn'> & Partial<Pick<Optional<UndefinedInitialDataOptions<Types.Order, unknown, Types.Order>, 'queryFn'>, 'queryFn'>> = {
};
...
export function useGetOrderByIdQuery<TSelectData = Types.Order, TError = unknown>(dto: GetOrderByIdQueryParameters, options?: Omit<Optional<UndefinedInitialDataOptions<Types.Order, TError, TSelectData>, 'queryFn'>, 'queryKey'>, axiosConfig?: Partial<AxiosRequestConfig>): UseQueryResult<TSelectData, TError>;
/**
 * Find purchase order by ID
 * @param orderId ID of pet that needs to be fetched
 * @return successful operation
 */
export function useGetOrderByIdQuery<TSelectData = Types.Order, TError = unknown>(orderId: number, options?: Omit<Optional<UndefinedInitialDataOptions<Types.Order, TError, TSelectData>, 'queryFn'>, 'queryKey'>, axiosConfig?: Partial<AxiosRequestConfig>): UseQueryResult<TSelectData, TError>;
export function useGetOrderByIdQuery<TSelectData = Types.Order, TError = unknown>(...params: any []): UseQueryResult<TSelectData, TError> {
  let options: Optional<UndefinedInitialDataOptions<Types.Order, TError, TSelectData>, 'queryFn'> | undefined = undefined;
  let axiosConfig: AxiosRequestConfig |undefined = undefined;
  ...
  return injectQuery()<Types.Order, TError, TSelectData>({
    queryFn: axiosConfig ? (context) => __getOrderById(context, axiosConfig) : __getOrderById,
    queryKey: getOrderByIdQueryKey(orderId),
    ...getOrderByIdDefaultOptions as unknown as Omit<Optional<UndefinedInitialDataOptions<Types.Order, TError, TSelectData>, 'queryFn'>, 'queryKey'>,
    ...options,
  });
}
/**
 ...
 */
export function useDeleteOrderMutation<TContext>(orderId: number, options?: Omit<Optional<CreateMutationOptions<void, unknown, void, TContext>, 'mutationFn'>, 'mutationKey' | 'mutationFn'>) {
 ...
 * @param orderId ID of the order that needs to be deleted
 */
export function useDeleteOrderMutationWithParameters<TContext>(options?: Omit<Optional<CreateMutationOptions<void, unknown, DeleteOrder__MutationParameters, TContext>, 'mutationFn'>, 'mutationKey' | 'mutationFn'> & { parameters?: DeleteOrderQueryParameters}) {
 ...
 * @return successful operation
 */
export function useCreateUsersWithListInputMutation<TContext>(options?: Omit<Optional<CreateMutationOptions<void, unknown, Types.User[], TContext>, 'mutationFn'>, 'mutationKey' | 'mutationFn'>) {
...
let getUserByNameDefaultOptions: Omit<Optional<UndefinedInitialDataOptions<Types.User, unknown, Types.User>, 'queryFn'>, 'queryKey' | 'queryFn'> & Partial<Pick<Optional<UndefinedInitialDataOptions<Types.User, unknown, Types.User>, 'queryFn'>, 'queryFn'>> = {
};
...
export function useGetUserByNameQuery<TSelectData = Types.User, TError = unknown>(dto: GetUserByNameQueryParameters, options?: Omit<Optional<UndefinedInitialDataOptions<Types.User, TError, TSelectData>, 'queryFn'>, 'queryKey'>, axiosConfig?: Partial<AxiosRequestConfig>): UseQueryResult<TSelectData, TError>;
/**
 * Get user by user name
 * @param username The name that needs to be fetched. Use user1 for testing.
 * @return successful operation
 */
export function useGetUserByNameQuery<TSelectData = Types.User, TError = unknown>(username: string, options?: Omit<Optional<UndefinedInitialDataOptions<Types.User, TError, TSelectData>, 'queryFn'>, 'queryKey'>, axiosConfig?: Partial<AxiosRequestConfig>): UseQueryResult<TSelectData, TError>;
export function useGetUserByNameQuery<TSelectData = Types.User, TError = unknown>(...params: any []): UseQueryResult<TSelectData, TError> {
  let options: Optional<UndefinedInitialDataOptions<Types.User, TError, TSelectData>, 'queryFn'> | undefined = undefined;
  let axiosConfig: AxiosRequestConfig |undefined = undefined;
  ...
  return injectQuery()<Types.User, TError, TSelectData>({
    queryFn: axiosConfig ? (context) => __getUserByName(context, axiosConfig) : __getUserByName,
    queryKey: getUserByNameQueryKey(username),
    ...getUserByNameDefaultOptions as unknown as Omit<Optional<UndefinedInitialDataOptions<Types.User, TError, TSelectData>, 'queryFn'>, 'queryKey'>,
    ...options,
  });
}
/**
 ...
 */
export function useUpdateUserMutation<TContext>(username: string, options?: Omit<Optional<CreateMutationOptions<void, unknown, Types.User, TContext>, 'mutationFn'>, 'mutationKey' | 'mutationFn'>) {
 ...
 * @param body Updated user object
 */
export function useUpdateUserMutationWithParameters<TContext>(options?: Omit<Optional<CreateMutationOptions<void, unknown, UpdateUser__MutationParameters, TContext>, 'mutationFn'>, 'mutationKey' | 'mutationFn'> & { parameters?: UpdateUserQueryParameters}) {
 ...
 */
export function useDeleteUserMutation<TContext>(username: string, options?: Omit<Optional<CreateMutationOptions<void, unknown, void, TContext>, 'mutationFn'>, 'mutationKey' | 'mutationFn'>) {
 ...
 * @param username The name that needs to be deleted
 */
export function useDeleteUserMutationWithParameters<TContext>(options?: Omit<Optional<CreateMutationOptions<void, unknown, DeleteUser__MutationParameters, TContext>, 'mutationFn'>, 'mutationKey' | 'mutationFn'> & { parameters?: DeleteUserQueryParameters}) {
...
let loginUserDefaultOptions: Omit<Optional<UndefinedInitialDataOptions<string, unknown, string>, 'queryFn'>, 'queryKey' | 'queryFn'> & Partial<Pick<Optional<UndefinedInitialDataOptions<string, unknown, string>, 'queryFn'>, 'queryFn'>> = {
};
...
export function useLoginUserQuery<TSelectData = string, TError = unknown>(dto: LoginUserQueryParameters, options?: Omit<Optional<UndefinedInitialDataOptions<string, TError, TSelectData>, 'queryFn'>, 'queryKey'>, axiosConfig?: Partial<AxiosRequestConfig>): UseQueryResult<TSelectData, TError>;
/**
 ...
 * @return successful operation
 */
export function useLoginUserQuery<TSelectData = string, TError = unknown>(username: string, password: string, options?: Omit<Optional<UndefinedInitialDataOptions<string, TError, TSelectData>, 'queryFn'>, 'queryKey'>, axiosConfig?: Partial<AxiosRequestConfig>): UseQueryResult<TSelectData, TError>;
export function useLoginUserQuery<TSelectData = string, TError = unknown>(...params: any []): UseQueryResult<TSelectData, TError> {
  let options: Optional<UndefinedInitialDataOptions<string, TError, TSelectData>, 'queryFn'> | undefined = undefined;
  let axiosConfig: AxiosRequestConfig |undefined = undefined;
  let username: any = undefined;
  ...
  return injectQuery()<string, TError, TSelectData>({
    queryFn: axiosConfig ? (context) => __loginUser(context, axiosConfig) : __loginUser,
    queryKey: loginUserQueryKey(username, password),
    ...loginUserDefaultOptions as unknown as Omit<Optional<UndefinedInitialDataOptions<string, TError, TSelectData>, 'queryFn'>, 'queryKey'>,
    ...options,
  });
}
/**
...
let logoutUserDefaultOptions: Omit<Optional<UndefinedInitialDataOptions<void, unknown, void>, 'queryFn'>, 'queryKey' | 'queryFn'> & Partial<Pick<Optional<UndefinedInitialDataOptions<void, unknown, void>, 'queryFn'>, 'queryFn'>> = {
};
 ...
 * @return successful operation
 */
export function useLogoutUserQuery<TSelectData = void, TError = unknown>(options?: Omit<Optional<UndefinedInitialDataOptions<void, TError, TSelectData>, 'queryFn'>, 'queryKey'>, axiosConfig?: Partial<AxiosRequestConfig>): UseQueryResult<TSelectData, TError>;
export function useLogoutUserQuery<TSelectData = void, TError = unknown>(...params: any []): UseQueryResult<TSelectData, TError> {
  let options: Optional<UndefinedInitialDataOptions<void, TError, TSelectData>, 'queryFn'> | undefined = undefined;
  let axiosConfig: AxiosRequestConfig |undefined = undefined;
  ...
  return injectQuery()<void, TError, TSelectData>({
    queryFn: axiosConfig ? (context) => __logoutUser(context, axiosConfig) : __logoutUser,
    queryKey: logoutUserQueryKey(),
    ...logoutUserDefaultOptions as unknown as Omit<Optional<UndefinedInitialDataOptions<void, TError, TSelectData>, 'queryFn'>, 'queryKey'>,
    ...options,
  });
}
/**
 ...
 * @return successful operation
 */
export function useCreateUsersWithArrayInputMutation<TContext>(options?: Omit<Optional<CreateMutationOptions<void, unknown, Types.User[], TContext>, 'mutationFn'>, 'mutationKey' | 'mutationFn'>) {
 ...
 * @return successful operation
 */
export function useCreateUserMutation<TContext>(options?: Omit<Optional<CreateMutationOptions<void, unknown, Types.User, TContext>, 'mutationFn'>, 'mutationKey' | 'mutationFn'>) {
